...
set output "result/combined-get-latency.eps"

start_time=system("head -n1 data/combined-get-latency.ts|awk '{print $1}'")
...
plot \
'data/combined-get-latency.ts'    using ($1-start_time):($2) title "combined get latency"   lt 1 pt 0 lw 3 axes x1y1
