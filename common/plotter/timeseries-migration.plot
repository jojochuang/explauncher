...
set y2label "Number of migrations (evt/sec)" font "Helvetica,22" tc lt 1
...
set output "result/tag-migration.eps"
...
plot \
  ...
  'data/head-migration.ts'    using 1:($2) title "number of migration"   lt 1 pt 0 lw 1 axes x1y2
