...
runtime=20 # duration of the experiment
...
function GenerateBenchmarkParameter (){
  ...
  echo "MACE_LOG_AUTO_SELECTORS = \"BS_KeyValueClient Accumulator GlobalStateCoordinator TcpTransport::connect BaseTransport::BaseTransport DefaultMappingPolicy ServiceComposition\"" >> ${conf_file}
...
function runexp (){
  ...
  echo "lib.MApplication.services = KeyValueClient" >> ${conf_file}
