...
set output "result/migration-before-and-after-0.eps"
...
plot \
  'data/nocpu_migration_varying_context_size-l0.ts'    using 1:($2) title "Size = 0MB"   lt -1 pt 0 lw 1
  #'data/nocpu_migration_varying_context_size-l204800000.ts'    using 1:($2) title "S=204.8MB"   lt 2 pt 0 lw 1, \
  #'data/nocpu_migration_varying_context_size-l409600000.ts'    using 1:($2) title "S=409.6MB"   lt 3 pt 0 lw 1
...
set output "result/migration-before-and-after-100.eps"
...
plot \
  'data/nocpu_migration_varying_context_size-l102400000.ts'    using 1:($2) title "Size = 100MB"   lt -1 pt 0 lw 1
