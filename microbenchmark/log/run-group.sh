...
app="microbenchmark"
#logdir=/u/tiberius06_s/chuangw/logs/microbenchmark_archive/final01-cpuload
...
if [[ "$type" = "var_cpuload" ]]; then
  ...
  #logdir=/u/tiberius06_s/chuangw/logs/microbenchmark_archive/final03-cpuload-fixedcontexts
fi
