...
plot \
  'data/migration_scale_out_and_in-l0.ts'    using 1:($2) title "S=0MB"   lt -1 pt 0 lw 1, \
  'data/migration_scale_out_and_in-l100000000.ts'    using 1:($2) title "S=100MB"   lt 1 pt 0 lw 1, \
  'data/migration_scale_out_and_in-l200000000.ts'    using 1:($2) title "S=200MB"   lt 2 pt 0 lw 1, \
  'data/migration_scale_out_and_in-l400000000.ts'    using 1:($2) title "S=400MB"   lt 3 pt 0 lw 1
  #'data/nocpu_migration_scale_out_and_in_varying_context_size-l0.ts'    using 1:($2) title "S=0MB"   lt 3 pt 0 lw 1

  #'data/nocpu_migration_varying_context_size-l0.ts'    using 1:($2) title "S=0.0MB"   lt -1 pt 0 lw 1, \
  #'data/nocpu_migration_varying_context_size-l102400000.ts'    using 1:($2) title "S=102.4MB"   lt 1 pt 0 lw 1, \
  #'data/nocpu_migration_varying_context_size-l204800000.ts'    using 1:($2) title "S=204.8MB"   lt 2 pt 0 lw 1, \
